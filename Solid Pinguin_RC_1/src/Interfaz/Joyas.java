 ...
 * @author andrew
 */
public class Joyas extends Nodo {

    private ListaCircularImagenes ListaImagenes;
    /**
     * codigos de acción de las joyas
     *      false = aun no ha sido tomada
     *      true = la joya ha sido tomada
     */
    ...
    public void TomarJoya() {
        System.out.println("joya tomada, realizar animación para que no parezca que se come a la foquita xD ajajaj");
        this.accion = false;
